...
on('body', 'click', '.add_jurisdiction_form', function() {
  ...
  count_jurisdictions = container.querySelectorAll(".juri_block").length;
  block.innerHTML = '<div class="d-flex col-12 w-100 mt-0 juri_block"><div class="flex-1"><div class="row"><div class="select-control col-md-3 mt-2 load_content load_countries states_nieded" data-link="/load/countries"></div><div class="select-control col-md-3 mt-2 states_container"></div><div class="select-control col-md-3 mt-2 cities_container"></div><div class="input-control col-md-3 mt-2"><div class="d-flex justify-content-between align-items-center"><label class="input-control__label">Registration Number</label></div><input class="number" name="number" placeholder="Enter Registration Number" type="text"><div class="input-control__footer"></div></div><div class="select-control col-md-3 mt-2"><div class="d-flex justify-content-between"><div class="select-control__label">Year Admitted</div></div><div class="select-control__container" tabindex="0"><div class="select-control__main"><input class="year" type="number" name="year" list="year_list' + count_jurisdictions + '"><span class="datalist_container"></span></div><div class="select-control__footer"></div></div></div></div></div>';

  block.querySelector(".datalist_container").innerHTML = '<datalist id="year_list' + count_jurisdictions + '"><option value="1960"></option><option value="1961"></option><option value="1962"></option><option value="1963"></option><option value="1964"></option><option value="1965"></option><option value="1966"></option><option value="1967"></option><option value="1968"></option><option value="1969"></option><option value="1970"></option><option value="1971"></option><option value="1972"></option><option value="1973"></option><option value="1974"></option><option value="1975"></option><option value="1976"></option><option value="1977"></option><option value="1978"></option><option value="1979"></option><option value="1980"></option><option value="1981"></option><option value="1982"></option><option value="1983"></option><option value="1984"></option><option value="1985"></option><option value="1986"></option><option value="1987"></option><option value="1988"></option><option value="1989"></option><option value="1990"></option><option value="1991"></option><option value="1992"></option><option value="1993"></option><option value="1994"></option><option value="1995"></option><option value="1996"></option><option value="1997"></option><option value="1998"></option><option value="1999"></option><option value="2000"></option><option value="2001"></option><option value="2002"></option><option value="2003"></option><option value="2004"></option><option value="2005"></option><option value="2006"></option><option value="2007"></option><option value="2008"></option><option value="2009"></option><option value="2010"></option><option value="2011"></option><option value="2012"></option><option value="2013"></option><option value="2014"></option><option value="2015"></option><option value="2016"></option><option value="2017"></option><option value="2018"></option><option value="2019"></option><option value="2020"></option><option value="2021"></option><option value="2022"></option><option value="2023"></option><option value="2024"></option></datalist>'
